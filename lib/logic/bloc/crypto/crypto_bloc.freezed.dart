...
abstract class _Started implements CryptoEvent {
...
abstract class _Show implements CryptoEvent {
...
mixin _$CryptoState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Crypto> crypto) loadedShow,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Crypto> crypto)? loadedShow,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
...
abstract class _IsLoading implements CryptoState {
...
class _$_IsError implements _IsError {
  ...
  @override
  String toString() {
    return 'CryptoState.isError(networkExceptions: $networkExceptions)';
  }
...
abstract class _IsError implements CryptoState {
...
class _$_LoadedShow implements _LoadedShow {
  const _$_LoadedShow(final List<Crypto> crypto) : _crypto = crypto;
  ...
  @override
  String toString() {
    return 'CryptoState.loadedShow(crypto: $crypto)';
  }
...
abstract class _LoadedShow implements CryptoState {
  const factory _LoadedShow(final List<Crypto> crypto) = _$_LoadedShow;
