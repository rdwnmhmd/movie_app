...
class ShimmerOutlet extends StatefulWidget {
  const ShimmerOutlet({Key? key}) : super(key: key);

  @override
  State<ShimmerOutlet> createState() => _ShimmerOutletState();
}

class _ShimmerOutletState extends State<ShimmerOutlet> {
  @override
